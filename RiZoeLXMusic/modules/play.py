...
from RiZoeLXMusic.config import ARQ_API_KEY
...
from RiZoeLXMusic.helpers.filters import command
from RiZoeLXMusic.helpers.filters import other_filters
from RiZoeLXMusic.helpers.gets import get_file_name
from RiZoeLXMusic.services.callsmusic import callsmusic
from RiZoeLXMusic.services.callsmusic import client as USER
from RiZoeLXMusic.services.converter.converter import convert
from RiZoeLXMusic.services.downloaders import youtube
from RiZoeLXMusic.services.queues import queues
    ...
    if type_ == "pause":
        ...
        if chet_id not in callsmusic.active_chats:
            ...
            if queues.is_empty(chet_id):
                ...
                await cb.answer.reply_text("✔︎ <b>Skipped</b>")
...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/1ed5d40197b17f06d00ba.jpg"
    ...
    if chat_id in callsmusic.active_chats:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"#RiZ Your requested song <b>queued</b> at position {position}!",
...
async def deezer(client: Client, message_: Message):
    ...
    try:
        ...
        thumbnail = "https://telegra.ph/file/1ed5d40197b17f06d00ba.jpg"
